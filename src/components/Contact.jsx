          ...
          <div className="max-w-5xl mx-auto rounded-2xl overflow-hidden"
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-[40%] p-6 lg:p-8 flex flex-col"
                ...
                <p className="text-white/50 text-[13px] mb-8">Reach out for queries or appointments</p>
                ...
                <div className="space-y-5 flex-1">
                  <a href="tel:+919324219275" className="flex items-center gap-3.5 group">
                    ...
                    <div>
                      <div className="text-white/50 text-[11px]">Call Us</div>
                  ...
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <div className="text-white/50 text-[11px]">Contact Person</div>
                  ...
                  <a href="mailto:info@healthianslabs.com" className="flex items-center gap-3.5 group">
                    ...
                    <div>
                      <div className="text-white/50 text-[11px]">Email</div>
                  ...
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <div className="text-white/50 text-[11px]">Service Area</div>
              ...
              {/* Form */}
              <div className="lg:w-[60%] p-6 lg:p-8 bg-white flex flex-col">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 flex-1 flex flex-col">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input type="text" required placeholder="Your name" value={form.name} onChange={update('name')}
                            className="w-full pl-10 pr-3.5 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all" />
                        </div>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select value={form.package} onChange={update('package')}
                          className="w-full pl-10 pr-3.5 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all bg-white appearance-none cursor-pointer">
                    ...
                    <div>
                      ...
                      <textarea rows={3} placeholder="Any specific requirements..." value={form.message} onChange={update('message')}
                        className="w-full px-3.5 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all resize-none" />
                    </div>
